...
export const en = {
  ...
  'search.words': 'Words that match',
  'search.recent': 'Looked for lately',
  'search.forgetOne': 'Forget {query}',
  'search.forgetAll': 'Forget these',
  ...
  'folders.make': 'New shelf',
  'folders.rename': 'Rename {name}',
  'folders.drop': 'Delete {name}',
  'folders.dropSure': 'Delete the shelf “{name}”? The works on it stay, off every shelf.',
